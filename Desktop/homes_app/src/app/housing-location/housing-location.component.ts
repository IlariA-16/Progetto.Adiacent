import { Component, Input, Output, EventEmitter, inject } from '@angular/core'; // AGGIUNTO Output, EventEmitter
...
export class HousingLocationComponent {
  ...
  @Output() favChanged = new EventEmitter<void>(); // 1. CREA L'EVENTO
  ...
  toggleFavorite(event: Event) {
    ...
    this.favChanged.emit(); // 2. LANCIA IL SEGNALE
  }

  getGoogleMapsLink(): string {
    const query = encodeURIComponent(`${this.housingLocation.name}, ${this.housingLocation.city}, ${this.housingLocation.state}`);
